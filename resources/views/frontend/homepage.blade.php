                ...
                <div class="slider-title_box">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h1 style="color: #FF3A6D; font-weight: bold;">Temukan tempat hebat di Jakarta</h1>
        ...
        <div class="row">
            @foreach($products as $product)
                <div class="col-md-4 featured-responsive">
                    ...
                    <a href="{{ route('products.show', ['subdomain' => optional($product->created_by)->subdomain ?? 'default-subdomain', 'product' => $product->id]) }}">
